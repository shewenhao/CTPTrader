...
/////多腿数据合并                             //////
////////////////////////////////////////////////////
Quote:        h"-5000#select  Date: Date, ReceiveDate:ReceiveDate, Symbol:Symbol, BidPrice1: BidPrice1, BidVol1:BidVol1, AskPrice1:AskPrice1, AskVol1: AskVol1 from Quote"; 
PairLegOne:   NumberOfLeg#select  Date: Date, ReceiveDate:ReceiveDate, Symbol:Symbol, BidPrice1: BidPrice1, BidVol1:BidVol1, AskPrice1:AskPrice1, AskVol1: AskVol1 from Quote where Symbol = PairLeg1Symbol;
PairLegTwo:   NumberOfLeg#select  Date: Date, ReceiveDate:ReceiveDate, Symbol:Symbol, BidPrice1: BidPrice1, BidVol1:BidVol1, AskPrice1:AskPrice1, AskVol1: AskVol1 from Quote where Symbol = PairLeg2Symbol;
PairLegThree: NumberOfLeg#select  Date: Date, ReceiveDate:ReceiveDate, Symbol:Symbol, BidPrice1: BidPrice1, BidVol1:BidVol1, AskPrice1:AskPrice1, AskVol1: AskVol1 from Quote where Symbol = PairLeg3Symbol;
...
/////策略逻辑判断                             //////
////////////////////////////////////////////////////
SignalLast:-1#select from Signal;delete from `SignalLast where Signal = 0N;delete from `SignalLast where LowerBand = 0N; delete from `SignalLast where HigherBand = 0N;FinalSignal:FinalSignal,SignalLast;
