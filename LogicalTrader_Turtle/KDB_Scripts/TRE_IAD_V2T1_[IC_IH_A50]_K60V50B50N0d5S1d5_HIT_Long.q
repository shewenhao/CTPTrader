...
delete second from `QuoteDataKindle;
////////////////////////////////////////////////////
/////信号计算准备                             //////
////////////////////////////////////////////////////
...
if[((LocalHigh - AskPrice1) > DrawBack) and (PositionAddedTimes > 0);(DrawBack:(LocalHigh - AskPrice1))];
////////////////////////////////////////////////////
/////三大逻辑判断                             //////
////////////////////////////////////////////////////
//根据时间判断是否平仓
if[(WhetherInCoverTime) and (PositionAddedTimes > 0);PositionAddedTimes:0;TrailShortLong:-1#select from QuoteDataKindle;update Signal:0 from `TrailShortLong;update BidPrice1Open:333 from `TrailShortLong; ShortLong: ShortLong, TrailShortLong;];
//回撤幅度判断是否平仓LocalHigh:
